...
<section class="section swiper-container swiper-slider swiper-slider-modern" data-loop="true" data-autoplay="5000" data-simulate-touch="true" data-nav="true" data-slide-effect="fade">
  <div class="swiper-wrapper text-left">
          ...
          <div class="row justify-content-center justify-content-xxl-start">
            <div class="col-md-10 col-xxl-6">
              <div class="slider-modern-box">
                <h1 class="slider-modern-title"><span data-caption-animate="slideInDown" data-caption-delay="0">Pizzaria Tio Gôga</span></h1>
                <p data-caption-animate="fadeInRight" data-caption-delay="400">Venha conhecera a melhor pizza de Samambaia </p>
    ...
    <div class="swiper-slide context-dark" data-slide-bg="images/pizza03.jpg">
      <div class="swiper-slide-caption">
        <div class="container">
          <div class="row justify-content-center justify-content-xxl-start">
            <div class="col-md-10 col-xxl-6">
              <div class="slider-modern-box">
                <h1 class="slider-modern-title"><span data-caption-animate="slideInLeft" data-caption-delay="0">Massa especial</span></h1>
                <p data-caption-animate="fadeInRight" data-caption-delay="600">Massa de fabricação própria bem leve e macia.</p>
                <div class="oh button-wrap"><a class="button button-primary button-ujarak" href="about-us.html" data-caption-animate="slideInLeft" data-caption-delay="400">Veja mais</a></div>
              </div>
            </div>
          </div>
    ...
    <div class="row row-30 justify-content-center">
      ...
      <div class="col-sm-6 col-lg-4 wow fadeInRight" data-wow-delay=".1s">
        <article class="box-icon-ruby">
          <div class="unit box-icon-ruby-body flex-column flex-md-row text-md-left flex-lg-column align-items-center text-lg-center flex-xl-row text-xl-left">
            <div class="unit-left">
              <div class="box-icon-ruby-icon linearicons-cog"></div>
            </div>
            <div class="unit-body">
              <h4 class="box-icon-ruby-title"><a href="#">hamburguer</a></h4>
            </div>
          </div>
        </article>
      </div>
  ...
  <div class="container">
    <div class="row row-40 justify-content-center">
      <div class="col-sm-8 col-md-7 col-lg-6 wow fadeInLeft" data-wow-delay="0s">
        <div class="product-banner"><img src="images/bannerpizza.jpg" alt="" width="570" height="715" />
...
<section class="section text-center">
  <div class="parallax-container" data-parallax-img="images/Promocao Ativa.jpg">
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="oh-desktop">
          ...
          <article class="thumbnail thumbnail-mary thumbnail-sm wow slideInLeft" data-wow-delay="0s">
            ...
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/galeria/01-tumb.jpg" data-lightgallery="item"><img src="images/grid-gallery-1-370x303.jpg" alt="" width="370" height="303" /></a>
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="oh-desktop">
          ...
          <article class="thumbnail thumbnail-mary thumbnail-sm wow slideInUp" data-wow-delay=".1s">
            ...
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/gallery-original-2-1200x800.jpg" data-lightgallery="item"><img src="images/galeria/02-tumb.jpg" alt="" width="370" height="303" /></a>
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="oh-desktop">
          ...
          <article class="thumbnail thumbnail-mary thumbnail-sm wow slideInUp" data-wow-delay=".1s">
            ...
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/gallery-original-4-800x1200.jpg" data-lightgallery="item"><img src="images/galeria/01-tumb.jpg" alt="" width="370" height="303" /></a>
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="oh-desktop">
          ...
          <article class="thumbnail thumbnail-mary thumbnail-sm wow slideInLeft" data-wow-delay="0s">
            ...
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/gallery-original-5-800x1200.jpg" data-lightgallery="item"><img src="images/galeria/01-tumb.jpg" alt="" width="370" height="303" /></a>
